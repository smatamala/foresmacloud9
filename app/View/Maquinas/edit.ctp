...
<?php echo $this->Form->create('Maquina'); ?>
	<fieldset>
		<legend><?php echo __('Edit Maquina'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Maquina.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Maquina.id'))); ?></li>
